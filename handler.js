...
module.exports = {
    async handler(chatUpdate) {
        ...
        try {
            ...
            let isPrems = isROwner || db.data.users[m.sender].premiumTime > 0
...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        unreg: 'Hallo Kak,\n\nSepertinya Nomor Kakak belum terverifikasi di Database SMART BOT\nSilahkan verifikasi terlebih dahulu untuk menggunakan fitur yang ada di bot ini dengan cara mengetik:\n\n*.verifikasi* \n\nContoh: *.verifikasi*\n\nApabila kakak tidak mengerti cara verifikasi, silahkan ketik *.tutorial* untuk melihat cara verifikasi akun dan penggunaan Bot WhatsApp\n\nTerima Kasih..\n\nPowered By FWD',
