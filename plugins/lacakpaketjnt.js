...
let res = await fetch(`https://api.binderbyte.com/v1/track?api_key=304a8540c06c6eb61f1c4bff35a115b0c8b4ad7ac929052c92c5480d6160e84c&courier=jnt&awb=${text}`)
...
handler.help = ['lacakpaketjnt <No resi>']
handler.command = ['lacakpaketjnt']
handler.tags = ['lacak']
