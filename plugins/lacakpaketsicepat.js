...
// if (!text) throw `
// Contoh : ${usedPrefix + command} hjjh6818166
// `
// await m.reply("Tunggu sebentar sedang melacak paket anda...")
// let res = await fetch(`https://api.binderbyte.com/v1/track?api_key=304a8540c06c6eb61f1c4bff35a115b0c8b4ad7ac929052c92c5480d6160e84c&courier=sicepat&awb=${text}`)
...
// handler.help = ['lacakpaketsicepat <No resi>']
// handler.command = ['lacakpaketsicepat']
// handler.tags = ['lacak']
